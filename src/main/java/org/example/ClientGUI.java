...
public class ClientGUI extends JFrame {
    ...
    public JLabel getLblNewLabel() {
        if (lblNewLabel == null) {
            ...
            lblNewLabel.setBounds(20, 10, 50, 50);
        }
        return lblNewLabel;
    }
    ...
    public JTextField getInputName() {
        if (inputName == null) {
            ...
            inputName.setBounds(70, 25, 60, 30);
    ...
    public JTextField getInputIP() {
        if (inputIP == null) {
            ...
            inputIP.setBounds(190, 25, 60, 30);
        }
        return inputIP;
    }
    ...
    public JLabel getLblPort() {
        if (lblPort == null) {
            ...
            lblPort.setBounds(260, 10, 60, 51);
        }
        return lblPort;
    }
    ...
    public JTextField getInputPort() {
        if (inputPort == null) {
            ...
            inputPort.setBounds(330, 25, 60, 30);
        }
        return inputPort;
    }
    ...
    public JButton getBtnNewButton() {
        if (btnNewButton == null) {
            ...
            btnNewButton.setBounds(400, 15, 100, 45);
        }
        return btnNewButton;
    }
    ...
    public JPanel getPanel_1_1() {
        if (panel_1 == null) {
            ...
            panel_1.setBounds(12, 13, 520, 51);
        }
        return panel_1;
    }
    ...
    public JLabel getLblNewLabel_2() {
        if (lblNewLabel_2 == null) {
            lblNewLabel_2 = new JLabel("HoangIT");
